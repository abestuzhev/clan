...
var Home_Home = /*#__PURE__*/function () {
  ...
  Home_createClass(Home, [{
    ...
    value: function init() {
      this.slider.init();
      SimpleScrollbar.initAll(); // new Timer().startTimer();
...
router.on(function () {
  ...
  home.init();
  timer.startTimer(); // const $btn = document.querySelector('.banner-top .c-btn-layout');

  var $btn = document.querySelector('.banner-full .c-btn-layout');
